...
'''
Borrowed from GreedyViG main.py codebase
'''

def get_args_parser():
    parser = argparse.ArgumentParser('ClusterViG train and eval script', add_help=False)
    parser.add_argument('--batch-size', default=128, type=int)
    parser.add_argument('--gradient_accumulation', default=False, type=bool) 
    parser.add_argument('--epochs', default=300, type=int)

    # Model parameters
    parser.add_argument('--model', default='IsoClusterViG_Ti_n196_c4', type=str, metavar='MODEL',
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        'ClusterViG training and evaluation script', parents=[get_args_parser()])
